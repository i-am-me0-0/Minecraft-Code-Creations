...
execute store success score @s enchant_check run enchant @s[scores={enchant_check=2}] minecraft:knockback 1


#check of item al dit enchant heeft zo ja raise het level met 1 level. success zet enchant_check naar 1, fail naar 0
execute store success score @s enchant_check if items entity @s[scores={enchant_check=0}] weapon.mainhand *[enchantments~[{enchantments: "knockback", levels: 1}]] run item modify entity @s weapon.mainhand custom:knockback_raise_level
...
execute store success score @s enchant_check if items entity @s[scores={enchant_check=0}] weapon.mainhand *[enchantments~[{enchantments: "knockback", levels: 2}]] run function custom:messages/al_max_level
