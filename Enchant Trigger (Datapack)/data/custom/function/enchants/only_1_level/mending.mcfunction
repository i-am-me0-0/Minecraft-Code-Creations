...
execute store success score @s enchant_check run enchant @s[scores={enchant_check=2}] minecraft:mending 1
...
execute store success score @s enchant_check if items entity @s[scores={enchant_check=0}] weapon.mainhand *[enchantments~[{enchantments: "mending", levels: 1}]] run function custom:messages/al_max_level
